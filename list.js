document.addEventListener("DOMContentLoaded", () => {
    document.querySelector(".btn.btn-primary").addEventListener("click", event => {
        ...
        clone.querySelector("[data-id='image']").textContent= "https://static.wikia.nocookie.net/rick-and-morty933/images/a/a6/Rick_Sanchez.png/revision/latest/thumbnail/width/360/height/360?cb=20170925123206&path-prefix=de";
